...
// PUimage.cpp : Defines the class behaviors for the application.
//
...
CPUimageApp::CPUimageApp()
{
	...
	SetAppID(_T("PUimage.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CPUimageApp object

CPUimageApp theApp;


// CPUimageApp initialization
...
BOOL CPUimageApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_PUimageTYPE,
