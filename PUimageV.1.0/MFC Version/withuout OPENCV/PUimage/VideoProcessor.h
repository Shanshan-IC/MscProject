...
public:
	...
	bool setOutputVideo(const std::string &filename, int codec = 0, double framerate = 0.0, bool isColor = true);

	// set the output as a series of image files
	// extension must be ".jpg", ".bmp" ...
	bool setOutputImages(const std::string &filename, // filename prefix
...
private:
	...
	bool prepareWriter(double framerate = 0.0, bool isColor = true);
