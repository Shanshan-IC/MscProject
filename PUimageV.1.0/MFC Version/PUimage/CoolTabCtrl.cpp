...
CCoolTabCtrl::CPageItem* CCoolTabCtrl::AddPage(CWnd *pWnd, LPCTSTR sText, UINT IconID)
{
	...
	// if Page index is not equal to the nActivePage, then hide it
...
void CCoolTabCtrl::AutoSize()
{
	...
	//set the button initial width, and get the needed size
	...
	//when the needed width is over the actual width
...
{
	//transfter WM_NOTIFY meesage to the parent windows
