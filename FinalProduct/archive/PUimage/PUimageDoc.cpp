...
BEGIN_MESSAGE_MAP(CPUimageDoc, CDocument)
	...
	//ON_COMMAND(ID_PREVIEW_PREVIEW, &CPUimageDoc::OnPreviewPreview)
END_MESSAGE_MAP()
...
BOOL CPUimageDoc::OnOpenDocument(LPCTSTR lpszPathName)
{
	...
	//HRESULT hResult = m_image2.Load(lpszPathName);
	iplSrcImg = matImg;
...
void CPUimageDoc::OnFileOpen()
{
	...
	if (GetOpenFileName(&ofn))
	{
		...
		//HRESULT hResult = m_image2.Load(szFileName);
...
/*
void CPUimageDoc::OnPreviewPreview()
{
	//ShowWindowsDialog();
