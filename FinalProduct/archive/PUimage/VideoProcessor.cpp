 ...
 */
bool VideoProcessor::setOutputVideo(const std::string &filename, int codec, double framerate, bool isColor)
{
    outputFile = filename;
    extension.clear();
 ...
 * @return True if successful. False otherwise
 */
bool VideoProcessor::setOutputImages(const std::string &filename, const std::string &ext, int numberOfDigits, int startIndex)
{
...
bool VideoProcessor::createTemp(double framerate, bool isColor)
{
    ...
    tempFileList.push_back(outputFile);
